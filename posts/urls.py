...
urlpatterns = [
    ...
    path("api/<int:pk>/", views.PostDetailAPIView.as_view(), name="post_ud"),
    path("api/like/<int:pk>/", views.PostLikeAPIView.as_view(), name="post_like"),
    ...
    path("api/comment/reply/<int:post_id>/<int:comment_id>/", views.ReplyCreateAPIView.as_view(), name="reply_c"),
